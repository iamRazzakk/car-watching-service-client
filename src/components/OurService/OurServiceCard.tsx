...
const OurServiceCard: React.FC<{ service: Service }> = ({ service }) => {
  ...
  return (
    <div className="flex items-center justify-center p-4 card">
      <div className="max-w-sm w-full h-48 bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden flex flex-col">
